...
INTO TABLE gfcarga.tsh_controle_conv_115
Append      
(      
    ...
    VALOR_TOTAL_NF                     position(355:368)    ,
    BC_ICMS_NF                         position(369:382)    ,
    ICMS_NF                            position(383:396)    ,
    ISENTAS_E_NAO_TRIB_NF              position(397:410)    ,
    OUTROS_NF                          position(411:424)    ,
    ...
    VALOR_TOTAL_ITEM                   position(523:536)    ,
    DESCONTOS_ITEM                     position(537:550)    ,
    ACRESCIMO_DESP_ACESSORIAS_ITEM     position(551:564)    ,
    BC_ICMS_ITEM                       position(565:578)    ,
    ICMS_ITEM                          position(579:592)    ,
    ISENTAS_E_NAO_TRIB_ITEM            position(593:606)    ,
    OUTROS_ITEM                        position(607:620)    ,
