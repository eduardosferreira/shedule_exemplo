...
----------------------------------------------------------------------------------------------
  SISTEMA ..: GF
  MODULO ...:
  SCRIPT ...: controladorSPT_gera_conv115
  CRIACAO ..: 16/03/2022
...
def processar():
    ...
    ### Parametro opcional
    p_EXEC_PVA     = comum.getParametro('EXEC_PVA').upper()
    ...
    if v_lista_id_serie_levantamento :
        ...
        while v_lista_id_serie_levantamento :
            if len(v_lista_threads) < v_max_threads :
                ...
                v_parametros = "%s %s"%( id_serie_levantamento, p_EXEC_PVA )
...
if __name__ == "__main__":
    ...
    if not ret :
        ...
        comum.addParametro('MES_ANO_INICIAL', '-MI', "Mes e ano inicial no formato YYYYmm.", False)
        comum.addParametro('MES_ANO_FINAL',   '-MF', "Mes e ano final no formato YYYYmm.", False)
        comum.addParametro('UF',              '-UF', "UF dos dados a processar.", True)
        ...
        comum.addParametro('USUARIO',         '-U',  "Nome do usuario que iniciou o processo no Sparta .", True)
        ...
        comum.addParametro('EXEC_PVA',       '-EX',  'Executar PVA ? [S/N].', True, 'N', 'N')
