...
def realizaUpload() :
    ...
    if configuracoes.tipo_arquivo == 'conv115' :
        ...
        diretorios_trabalho['OBRIGACAO']['tipo'] = 'originais'
        ...
        diretorios_trabalho['INSUMOS']['mascara'] = ['Conciliacao_Serie_*_OK.xlsx']
        ...
        if(configuracoes.envia_relatorio == 'S'):
            ...
            diretorios_trabalho['RELATORIOS']['diretorio'] = os.path.join( configuracoes.caminho_sped_fiscal, 'RELATORIOS', configuracoes.uf,  configuracoes.ano, configuracoes.mes )
            diretorios_trabalho['RELATORIOS']['mascara'] = maska
            diretorios_trabalho['RELATORIOS']['tipo'] = 'analises'
            diretorios_trabalhox['APOIO'] = {}
            diretorios_trabalhox['APOIO']['diretorio'] = os.path.join( configuracoes.caminho_sped_fiscal, 'RELATORIOS', configuracoes.uf,  configuracoes.ano, configuracoes.mes, 'Apoio' )
            ...
            compacta = "zip -q -n zip " + arquivo_compactado  + " "
            arq_rel = nome_arquivo(maska,diretorios_trabalho['RELATORIOS']['diretorio'])
            if arq_rel:
        ...
        maskac = 'RELATORIOS.zip'
        maska = 'relatario_gia_totais_por_cfop_'+str(configuracoes.mes)+str(ano)+'_'+configuracoes.uf+'_'+configuracoes.ie+'_*.xlsx'
        ...
        if(configuracoes.envia_relatorio == 'S'):
            diretorios_trabalho['RELATORIOS'] = {}
            diretorios_trabalho['RELATORIOS']['diretorio'] = os.path.join(configuracoes.caminho_GIA+configuracoes.uf,'RELATORIOS',ano,configuracoes.mes)
            diretorios_trabalho['RELATORIOS']['mascara'] = maska
            diretorios_trabalho['RELATORIOS']['tipo'] = 'analises'
...
def processar() :
        ...
        if len(sys.argv) > 2 :
            ...
            if configuracoes.tipo_arquivo not in ['conv115', 'sped', 'gia', 'sef'] :
                ...
                if configuracoes.tipo_arquivo == 'conv115' :
                    ...
                    configuracoes.id_serie = sys.argv[2]
    ...
    if log.ret == 99 :
        ...
        log('               1 - <id_serie>  // * obrigatorio ')
        log('            Exemplo : ./upload_NPGF.py conv115 18000394')
        log('')
